...
10 September 2026 version automation: synchronized package version commands, PR version guard, and quality-gated main patch/tag automation are supplied. Atomic publication and stale-run checks are tested with local Git remotes; GitHub App configuration and hosted execution remain external setup. See VERSIONING.md and VALIDATION.md.
